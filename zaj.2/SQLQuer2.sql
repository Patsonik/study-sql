...
insert into miasto values ('G³ogów')
insert into miasto values ('Kotla')
insert into miasto values ('Bytom Odrzañski')
insert into miasto values ('Nowa Sól')
insert into miasto values ('Brzeg G³ogowski')



insert into osoba values ('Bo¿ena', 'Pingwiñska', '67-270', '67-270 ', '67-270')
insert into osoba values ('Piotr', 'Pingwiñski', '67-270 ', '67-270', '67-270')
...
insert into kierowca values ((select id_osoba from osoba where nazwisko = 'Pingwiñska'), 'B i D')
insert into kierowca values ((select id_osoba from osoba where nazwisko = 'Prastel'), 'B i D')
insert into pilot values ((select id_osoba from osoba where nazwisko = 'Pingwiñski'), 'Kurs pilotazu')
...
insert into linia values ((select id_miasto from miasto where nazwa_miasto = 'Kotla'), 
                          (select id_miasto from miasto where nazwa_miasto = 'Bytom Odrzañski'), 
                          (select id_miasto from miasto where nazwa_miasto = 'Nowa Sól'), 
                          (select id_miasto from miasto where nazwa_miasto = 'Brzeg G³ogowski'), 
                          (select id_miasto from miasto where nazwa_miasto = 'G³ogów'))
insert into linia values ((select id_miasto from miasto where nazwa_miasto = 'G³ogów'), 
